...
export const careerTimeline: CareerStage[] = [
  ...
  },
  {
    ...
    achievements: [
      "参与搜 e 销多端架构与 Webpack 模块联邦等构建优化。",
      "积累 CSRF / XSS 防护、Service Worker 缓存等工程实践。",
      "开始承担模块级方案设计与协作推动。",
    ],
  },
  {
    ...
    title: "叙简科技 · 前端开发工程师",
    summary:
      "Web 与 H5 快速交付，建立组件化、接口联调与兼容性处理的基本盘。",
    focus: ["Web / H5 还原", "REST 联调", "通用组件", "性能优化"],
    achievements: [
      "能独立搭建 Vue / React 项目工程体系并持续维护。",
      "编写高复用模块，提升团队交付效率。",
      "形成对代码规范与交互体验的系统自查习惯。",
    ],
  },
  {
    ...
    title: "北华大学 · 计算机科学与技术",
    summary:
      "本科阶段打好计算机基础，毕业后进入前端领域持续深耕。",
    focus: ["计算机基础", "前端入门", "工程思维"],
    achievements: [
      "计算机科学与技术本科毕业。",
      "毕业后快速适应企业级前端交付节奏。",
    ],
