    ...
    <div className="grid gap-4">
      ...
      <div className="flex flex-wrap items-start gap-6">
        ...
        >
          ...
          >
            <div className="border-b border-white/10 bg-slate-900/45 px-3 py-2 text-center text-[10px] text-slate-400">
            ...
            <div
              className="absolute inset-x-0 bottom-0 border-t border-cyan-300/20 bg-slate-950/45 px-3 py-2"
